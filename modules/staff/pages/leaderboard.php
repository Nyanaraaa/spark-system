                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="../../../modules/staff/pages/leaderboard_history.php" class="btn btn-gold btn-sm">
                                <i class="lni lni-archive me-1"></i> View History
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="search-container mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="search-input" class="form-control"
                                        placeholder="Search by name or employee ID" onkeyup="filterStaff()">
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="leaderboard-table" class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        // PHP logic to fetch and display leaderboard data
