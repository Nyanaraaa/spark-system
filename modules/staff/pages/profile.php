...
<head>
    ...
    <link rel="stylesheet"
        href="../../../assets/css/housekeeping_profile.css?v=<?php echo filemtime('../../../assets/css/housekeeping_profile.css'); ?>">
</head>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="profile-details mt-4">
                                ...
                                <div class="detail-item d-flex align-items-center mb-3 p-2 rounded"
                                    style="background-color: var(--gray-light);">
                                    <i class="lni lni-lock-alt me-3"
                                        style="color: var(--maroon); font-size: 1.2rem;"></i>
                                    <div>
                                        <div class="detail-label" style="color: var(--gray); font-size: 0.85rem;">
                                            Password</div>
                                        <div class="detail-value" style="font-weight: 500;">
                                            <?php echo htmlspecialchars($password); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
