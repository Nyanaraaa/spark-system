...
<body>
                                ...
                                <form id="reportForm" action="../../../modules/staff/api/submit_report.php"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea class="form-control" id="reportDescription" name="reportDescription"
                                            rows="4"
                                            placeholder="Enter a brief description of your progress..."></textarea>
                                    </div>
    ...
    <script>
        ...
        function validateCapture(event) {
            ...
            const timeDifference = now - fileLastModified;

            // If file was modified more than 5 minutes ago, it's likely from gallery
            if (timeDifference > 5 * 60 * 1000) {
                alert('Please take a new photo using your camera. Old photos from gallery are not allowed.');
                fileInput.value = ''; // Clear the input
                resetImagePreview();
                return;
            }

            // Check file size - camera photos are usually larger than very small files
            if (file.size < 10000) { // Less than 10KB is suspicious
                alert('Image file is too small. Please take a proper photo using your camera.');
                fileInput.value = '';
                resetImagePreview();
                return;
            }
