...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('../../../modules/supervisor/api/get_staff_names.php')
                .then(response => {
                    if (!response.ok) {
        ...
        function fetchSchedules(staffId) {
            ...
            fetch(`../../../modules/supervisor/api/get_schedules.php?staff_id=${staffId}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error(`HTTP error! status: ${response.status}`);
                    }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('../../../modules/supervisor/api/get_location.php')
                .then(response => {
                    if (!response.ok) {
                        throw new Error(`HTTP error! status: ${response.status}`);
                    }
        ...
        function deleteSchedule(scheduleId) {
            if (confirm('Are you sure you want to delete this schedule?')) {
                fetch('../api/delete_schedule.php?schedule_id=' + scheduleId)
                    .then(response => response.json())
                    .then(data => {
                        alert(data.message);
