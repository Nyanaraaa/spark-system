...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2">
                                    <!-- Removed the print button from here since it's now in the header -->
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('print-button').addEventListener('click', function () {
            ...
            printWindow.document.write('.bg-success { background-color: #28a745 !important; color: white; }');
            printWindow.document.write('.bg-warning { background-color: #ffc107 !important; color: black; }');
            printWindow.document.write('.bg-danger { background-color: #dc3545 !important; color: white; }');
            ...
            if (searchInput !== '' && fullNames.length > 0) {
                ...
                printWindow.document.write(`<h4 style="color: #800000; margin-bottom: 10px;">Staff Name: <span style="font-weight: normal;">${fullNames.join(', ')}</span></h4>`);
                printWindow.document.write(`<h5 style="color: #800000; margin-bottom: 0;">Employee ID: <span style="font-weight: normal;">${employeeIDs.join(', ')}</span></h5>`);
                printWindow.document.write('</div>');
            }
