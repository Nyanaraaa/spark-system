                        ...
                        <form action="auth/password-reset-code.php" method="POST">
                            ...
                            <div class="mb-3 input-group">
                                ...
                                <input type="text" class="form-control" id="username" placeholder="Enter new username"
                                    aria-describedby="username-icon" name="new_username">
                            </div>
                            <div class="mb-3 input-group">
                                <span class="input-group-text" id="password-icon">
                                    <i class="bi bi-lock-fill"></i>
                                </span>
                                <input type="password" class="form-control red-border" id="password"
                                    placeholder="Enter new password" aria-describedby="password-icon"
                                    name="new_password">
                            ...
                            <div class="mb-3 input-group" style="background-color: #f8f9fa;">
                                ...
                                <input type="password" class="form-control red-border" id="confirm-password"
                                    placeholder="Confirm password" aria-describedby="confirm-password-icon"
