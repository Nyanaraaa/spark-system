            ...
            <ul class="sidebar-nav list-unstyled">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#offcanvasSidebar">
                        <li class="sidebar-item">
                            <a href="<?php echo $base_path; ?>modules/supervisor/pages/staff_list.php" class="sidebar-link">Staff List</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo $base_path; ?>modules/supervisor/pages/staff_record.php" class="sidebar-link">Staff Record</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
